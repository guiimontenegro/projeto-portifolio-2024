...
export default function about() {
  return (
    <>
      <Head>
        <title>Guilherme Montenegro | About Page</title>
        <meta name='description' content='This is an about page of the portfolio website made by Guilherme Montenegro using TypeScript, TailwindCSS, React, NextJS, ThreeJS, Framer Motion. This page shows the information about me, 3d models, framer motion animations, my experience and my education.' />
      </Head>
          ...
          <div className='grid w-full grid-cols-8 gap-16 mobile:gap-8 '>
            <div className='col-start-1 col-end-5  flex flex-col items-start justify-start laptop:col-span-4 mini-tablet:order-2 mini-tablet:col-span-8 mt-6 laptop:mt-0'>
              ...
              <div className='font-medium'>
                ...
                <p>
                Having worked with wide-range of technologies such as JavaScript, TypeScript, React, SQL, NoSQL, REST API, GraphQL, Angular, C#, and WordPress allows me to handle any specific tech requirement for every project. I look forward to contributing my skills and passion to your next project.
                </p>
              </div>
            </div>
            ...
            <div className='col-start-7 col-end-9 flex items-end justify-between flex-col laptop:col-span-8 laptop:flex-row laptop:items-center mini-tablet:order-3'>
              ...
              <div className='flex flex-col items-end justify-center laptop:items-center'>
                ...
                <h2 className='font-medium text-lg desktop:text-base capitalize text-dark/75 dark:text-light/75 laptop:text-center mini-tablet:text-lg mobile:text-base mini-mobile:text-sm'>integrations, API's and pages created</h2>
              </div>
            </div>
          </div>
