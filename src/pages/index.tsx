...
export default function Home() {
  return (
    <>
      <Head>
        <title>Portfolio Website | Guilherme Montenegro</title>
        <meta name='description' content='Portfolio Website made by Guilherme Montenegro using TypeScript, TailwindCSS, React, NextJS, ThreeJS, Framer Motion. This page shows the 3D model and the short text about my love of front end development.' />
      </Head>
        ...
        <Layout className='pt-0 mini-tablet:pt-16 mobile:pt-8'>
          <div className="flex justify-between items-center w-full tablet:flex-col">
            ...
            <div className='flex flex-col w-1/2 items-center self-center pl-8 tablet:pl-0 tablet:w-full tablet:text-center tablet:mb-96'>
              <TextAnimation text='Creating new experiences through fluid, high-performance codes' className='!text-6xl text-left laptop:!text-5xl tablet:!text-center tablet:!text-6xl mini-tablet:!text-5xl mini-tablet:py-3 mobile:!text-3xl' />
              <p className='my-4 font-medium text-xl mini-tablet:text-sm mobile:text-xs'>
              Hi! My name is Guilherme Montenegro and I am a front end developer who enjoys building complex projects using expertise in web technologies and a passion for improving my craft every day.
              </p>
              <div className='flex items-center self-start mt-4 tablet:self-center'>
                <Link
                  href="mailto:guiimontenegro@gmail.com"
                  target={'_blank'}
